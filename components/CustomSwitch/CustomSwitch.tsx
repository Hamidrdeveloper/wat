...
import { Easing, View, Animated, Text, StyleSheet, TouchableOpacity, Image, Pressable } from "react-native";
...
export function ZeroOneSwitch({
  ...
  backgroundColorDisActive = "white",
  knobBorderColor,
  knobBorderWidth,
  imageStyle,
  imageOff,
  ...
  const styles = {
    container: {
      width: SIZE * 1,
      backgroundColor:value?backgroundColorActive:backgroundColorDisActive,
      height: SIZE * 0.5,
      borderRadius: SIZE * 0.15,
      elevation: elevation ? elevation : null,
      justifyContent: "center",
  ...
  return (
    <>
      <Pressable onPress={(e) => onChange()}>
        <Animated.View style={styles.container}>
          <Animated.View style={styles.knob}>
            <Image resizeMode="contain"source={!value?imageOff:imageOn} style={styles.imageStyle}/>
          </Animated.View>
        </Animated.View>
      </Pressable>
    </>
