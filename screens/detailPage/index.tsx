    ...
    <>
      ...
      <BackView>
        ...
        <TouchEditRight
          ...
          <IconRight resizeMode={"contain"} source={Icon} />
          </TouchEditRight>
            ...
            renderItem={({item}) => {
              ...
              return (
                <View style={{ width: (Dimensions.get('window').width-50)/3, height: 105 }}>
                  <ImageItem source={{uri:`${BASE_URL}/api/v1/files/${item?.photo}`}} />
                </View>
              );
            }}
          />
      ...
      >
        {objectsDetails?.location!=null?
         <MapView.Marker
              coordinate={{
                latitude:objectsDetails?.location?.lat!=null ?objectsDetails?.location?.lng:0,
                longitude: objectsDetails?.location?.lng!=null ?objectsDetails?.location?.lat:0,
              }}
